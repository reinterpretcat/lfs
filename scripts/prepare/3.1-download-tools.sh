...
case "$FETCH_TOOLCHAIN_MODE" in
  "0")
    ...
    wget --timestamping https://www.linuxfromscratch.org/museum/lfs-museum/8.2/wget-list

    echo "Getting packages.."
    wget --timestamping --continue --input-file=wget-list

    echo "Getting md5.."
    wget --timestamping https://www.linuxfromscratch.org/museum/lfs-museum/8.2/md5sums
